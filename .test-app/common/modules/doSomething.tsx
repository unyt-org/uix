...
export default <>
  ...
  <button onclick:display={doSomething}>Clickme #1</button>
  <button onclick={() => doSomething()}>Clickme #2</button>
  <button onclick:display={() => use (doSomething) && doSomething()}>Clickme #3</button>

  <button onclick={doSomething2}>Clickme #4</button>
  <button onclick:display={doSomething2}>Clickme #5</button>
  <button onclick={() => doSomething2()}>Clickme #6</button>
  <button onclick:display={() => use (doSomething2) && doSomething2()}>Clickme #7</button>

  <button onclick={() => alert("hi")}>Clickme #8</button>
  <button onclick:display={() => alert("hi")}>Clickme #9</button>
  <button onclick={() => use (alert) && alert("hi")}>Clickme #10</button>
  <button onclick:display={() => use (alert) && alert("hi")}>Clickme #11</button>
</>
